 	...
 	public void Evaluate(boolean type)
 	{
 		if(type)
 		{
 			//classify messages using keywords.
 	 		nbc.train("datasetA/hams" , "datasetA/spams" , "datasetA/hamKeywords.txt" , "datasetA/spamKeywords.txt");
 		}
 		
 		else
 		{
 			//classify messages using all the words that were found in messages.
 			nbc.train("datasetA/hams" , "datasetA/spams");
 		}
 		
 		Classify("datasetA/testMessages");
 	}
