...
public class SpamFC extends YahooBase implements MouseListener{
	static JLabel adds;
    static JLabel spam1;
    private static String s5;
    private JLabel[] Al;
	private int i;
    public SpamFC() throws IOException {
		new YahooBase();
		...
		String wor="";
		String temp="";
	File directory1=new File("datasetB/spamc");
    ...
    public static void add_spam()
    {
		...
		adds.addMouseListener(new MouseAdapter(){
			...
			System.out.println("Text Area contents are ");
				...
				File dir=new File("datasetB/spamc");
